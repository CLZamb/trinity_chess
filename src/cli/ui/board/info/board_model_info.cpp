...
const string BoardModelInfo::Kwrong_format = 
  "Move is an not in a recognizable format, please try again";
const string BoardModelInfo::Killegal_move = 
  "Move is an ilegal move";
const string BoardModelInfo::Kcheck_move = 
...
void BoardModelInfo::wrong_format(const string &s) {
  save_info("{ " + s + " } " + Kwrong_format);
}

void BoardModelInfo::illegal_move(const string &s) {
  save_info("{ " + s + " } " + Killegal_move);
}

void BoardModelInfo::in_check(const string &s) {
