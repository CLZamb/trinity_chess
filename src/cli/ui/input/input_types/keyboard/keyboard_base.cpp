...
InputKeyboardKeys::Key KeyboardBase::read_key() { 
  InputKeyboardKeys::Key key = m_k_reader.read_key();
  switch(key) {
    case InputKeyboardKeys::quit:
    case InputKeyboardKeys::Quit:
...
InputKeyboardKeys::Key KeyboardBase::read_arrow_key() {
