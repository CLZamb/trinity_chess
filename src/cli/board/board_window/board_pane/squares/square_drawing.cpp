...
SquareDrawing::SquareDrawing()
    : p_empty_square_drawing(&BoardDrawings::Squares::Ksquares.at(
...
void SquareDrawing::set_is_selected(const bool &s) { m_is_selected = s; }
...
void SquareDrawing::set_base_square_drawing(bool is_black_square) {
  ...
  p_empty_square_drawing = is_black_square
