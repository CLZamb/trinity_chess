...
#include <string>
#include "ui/view.h"
#include "ui/graphics/game_drawings.hpp"
...
class MenuView : public View {
  public: 
    ...
    MenuView(list<string> l_s) : View("Menu"), m_l_options(l_s) {
      ...
      m_pane.get_section(m_top_section)->set_content_at_index(MenuDrawings::menu_top.data(), 0 );
      m_pane.get_section(m_bottom_section)->set_content_at_index(MenuDrawings::menu_bottom.data(), 0 );
